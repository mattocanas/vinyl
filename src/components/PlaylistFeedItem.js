        ...
        <TouchableOpacity
          ...
          <View
            ...
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              ...
              <View>
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  <Text style={styles.usernameText}>{data.creatorName}</Text>
                  {data.verified ? (
                ...
                <Text style={styles.subUsername}>@{data.creatorUsername}</Text>
              </View>
            ...
            <View>
              <Text style={styles.description}>
                @{data.creatorUsername} has created a new collaborative
