...
const PlaylistAddPost = ({
  ...
  const onLike = () => {
    ...
    //   .doc(data.docId)
    //   .set({
    //     profilePictureUrl: data.addedByProfilePicture,
    //     uid: data.addedById,
    //     username: data.addedByUsername,
    //     date: data.addedOnDate,
    //     likes: data.likes,
    //     comments: data.comments,
    //     docId: data.docId,
    //     type: data.type,
    //     verified: data.addedByVerified,
    //   });
      ...
      {true ? (
        ...
        <View
          ...
          <View style={{flexDirection: 'row', alignItems: 'center'}}>
            ...
            <View>
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                <Text style={styles.usernameText}>{data.addedByName}</Text>
                {data.addedByVerified ? (
              ...
              <Text style={styles.subUsername}>@{data.addedByUsername}</Text>
            </View>
          ...
          <View>
            <Text style={styles.description}>
              I added this track to{' '}
              <Text
                style={styles.usernameTextLink}
                onPress={() =>
                  navigationUse.navigate('FeedUserDetailScreen', {
                    data: data.playlistOwner,
                  })
                }>
                @{data.playlistOwnerUsername}
              </Text>
              's playlist: <Text>{data.playlistName}</Text>
            </Text>
...
export default PlaylistAddPost;
